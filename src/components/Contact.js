            ...
            <div className='container mx-auto'>
              <div className='flex flex-col lg:flex-row'>
               ...
               <motion.form variants={fadeIn('left',0.3)} 
                            ...
                            whileInView={'show'} 
                            viewport={{once:false, amount: 0.3}}
                            className='flex-1 border-2 rounded-2xl flex flex-col gap-y-6 pb-24 p-6'>
                  ...
                  <textarea className='bg-transparent border-b py-12 outline-none w-full placeholder:text-white  focus:border-accent transition-all resize-none mb-12' placeholder='Your Meassage'></textarea>
